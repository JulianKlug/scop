...
class Resnet3DBuilder(object):
    ...
    @staticmethod
    def build_resnet_18(input_shape, num_outputs, regression, reg_factor=1e-4):
        """Build resnet 18."""
        return Resnet3DBuilder.build(input_shape, num_outputs, basic_block,
                                     [2, 2, 2, 2], reg_factor=reg_factor, regression=regression)

    @staticmethod
    def build_resnet_34(input_shape, num_outputs, regression, reg_factor=1e-4):
        """Build resnet 34."""
        return Resnet3DBuilder.build(input_shape, num_outputs, basic_block,
                                     [3, 4, 6, 3], reg_factor=reg_factor, regression=regression)

    @staticmethod
    def build_resnet_50(input_shape, num_outputs, regression, reg_factor=1e-4):
        """Build resnet 50."""
        return Resnet3DBuilder.build(input_shape, num_outputs, bottleneck,
                                     [3, 4, 6, 3], reg_factor=reg_factor, regression=regression)

    @staticmethod
    def build_resnet_101(input_shape, num_outputs, regression, reg_factor=1e-4):
        """Build resnet 101."""
        return Resnet3DBuilder.build(input_shape, num_outputs, bottleneck,
                                     [3, 4, 23, 3], reg_factor=reg_factor, regression=regression)

    @staticmethod
    def build_resnet_152(input_shape, num_outputs, regression, reg_factor=1e-4):
        """Build resnet 152."""
        return Resnet3DBuilder.build(input_shape, num_outputs, bottleneck,
